...
🔄 FreeRTOS multitasking — two independent tasks running concurrently: one handling the full sensor-PID-motor control loop, another managing the LCD display over
I2C without ever blocking motor actuation
